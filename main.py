...
db = Database("Data_base.db")
root = Tk()
root.title("Py_Organiser")
...
title = Label(entries_frame, text="Py_Organiser", font=("Calibri", 18, "bold"), bg="#535c68", fg="white")
...
lblAge = Label(entries_frame, text="Tag", font=("Calibri", 16), bg="#535c68", fg="white")
lblAge.grid(row=1, column=2, padx=10, pady=10, sticky="w")
txtAge = Entry(entries_frame, textvariable=age, font=("Calibri", 16), width=30)
txtAge.grid(row=1, column=3, padx=10, pady=10, sticky="w")

lbldoj = Label(entries_frame, text="Quantity", font=("Calibri", 16), bg="#535c68", fg="white")
...
lblEmail = Label(entries_frame, text="Price", font=("Calibri", 16), bg="#535c68", fg="white")
lblEmail.grid(row=2, column=2, padx=10, pady=10, sticky="w")
txtEmail = Entry(entries_frame, textvariable=email, font=("Calibri", 16), width=30)
txtEmail.grid(row=2, column=3, padx=10, pady=10, sticky="w")

lblGender = Label(entries_frame, text="Status", font=("Calibri", 16), bg="#535c68", fg="white")
lblGender.grid(row=3, column=0, padx=10, pady=10, sticky="w")
comboGender = ttk.Combobox(entries_frame, font=("Calibri", 16), width=28, textvariable=gender, state="readonly")
comboGender['values'] = ("Full", "50/50","Less")
comboGender.grid(row=3, column=1, padx=10, sticky="w")

lblContact = Label(entries_frame, text="Date", font=("Calibri", 16), bg="#535c68", fg="white")
...
lblAddress = Label(entries_frame, text="Description", font=("Calibri", 16), bg="#535c68", fg="white")
...
tv.heading("3", text="Tag")
tv.column("3", width=5)
tv.heading("4", text="Quanity")
